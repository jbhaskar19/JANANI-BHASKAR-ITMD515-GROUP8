...
function validateDealerRemoveCarPart(){
	var myvalid=true;
	alert(document.getElementById("cpquantity").value);
...
<select id="cpquantity" name="cpquantity">
  <%for (int i=1;i<=Integer.parseInt(cpi.getQuantity());i++){ %>
  <option value=<%=i %>><%=i %></option><%} %>
</select>
<input id="ccapacity" name="ccapacity" style="border:0; padding-left:20px" type="hidden" value=<%=cpi.getQuantity()%>><br>
